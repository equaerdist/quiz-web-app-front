...
const QuizPage = () => {
  ...
  const [paramHeight, setParamHeight] = useState<string>("0px");
  ...
  const onSettingSwitch = () =>
    setParamHeight((prevHeight) => (prevHeight === "auto" ? "0px" : "auto"));
  const quizParameters: CSSProperties | undefined = isMobile
    ? {
        height: paramHeight,
        padding: paramHeight === "auto" ? "55px 41px" : "0px",
        opacity: paramHeight === "auto" ? "100" : "0",
      }
    : undefined;
  return (
    <div className="quiz">
      <div className="wrapper switch">
        {isMobile ? (
          <img src={settings} className="icon" onClick={onSettingSwitch} />
        ) : null}
        <div className="quiz__parameters" style={quizParameters}>
